...
/*
 *  Camada DAO para Responsavel
 */
public class ResponsavelDAO {
	/* Cadastra uma entidade Responsavel no banco de dados.
	 * Lança uma exceção caso ocorra um SQLException
	 * @param ResponsavelaEntity responsavel
	 */
	public void cadastrarResponsavel(ResponsavelEntity responsavel) {
		...
		try {
			...
			// Cadasta os dados da entidade Responsavel
